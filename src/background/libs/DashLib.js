...
class DashLibClass{
    ...
    getBalance(raw=true){
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                let url = `https://api.blockcypher.com/v1/dash/main/addrs/${address}/balance`;
    ...
    sendTransaction(to,amount,fee){
        return new Promise(async(resolve,reject)=>{
            try{
                ...
                let url = `https://api.blockcypher.com/v1/dash/main/txs/push?token=${token}`
    ...
    listUnspent(address){
        return new Promise(async(resolve,reject)=>{
            try{
                this.validator.validateBtcAddress(address);
                let url = `https://api.blockcypher.com/v1/dash/main/addrs/${address}?unspentOnly=true`
